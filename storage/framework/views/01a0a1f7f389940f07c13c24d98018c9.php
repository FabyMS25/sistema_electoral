    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        <thead class="table-light">
            <tr>
                ...
                <th>Color</th>
                <th>
                    <a href="<?php echo e(route('candidates.index', array_merge(request()->query(), ['sort' => 'election_type_category_id', 'direction' => request('sort') == 'election_type_category_id' && request('direction') == 'asc' ? 'desc' : 'asc']))); ?>" 
                       class="text-dark text-decoration-none">
                        Elección / Categoría
                        <?php if(request('sort') == 'election_type_category_id'): ?>
                            <i class="ri-arrow-<?php echo e(request('direction') == 'asc' ? 'up' : 'down'); ?>-line"></i>
                        <?php endif; ?>
                    </a>
                </th>
                <th>
                    <a href="<?php echo e(route('candidates.index', array_merge(request()->query(), ['sort' => 'type', 'direction' => request('sort') == 'type' && request('direction') == 'asc' ? 'desc' : 'asc']))); ?>" 
                       class="text-dark text-decoration-none">
                        Tipo
                ...
                <tr>
                    ...
                    <td class="type">
                        <span class="badge 
                            ...
                            <?php echo e($typeOptions[$candidate->type] ?? $candidate->type); ?>
...
</div><?php /**PATH D:\_Mine\corporate\resources\views/candidates/partials/table.blade.php ENDPATH**/ ?>