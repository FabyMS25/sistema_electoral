...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('voting-tables.import')); ?>" enctype="multipart/form-data" id="import-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <br>
                        <a href="<?php echo e(route('voting-tables.template')); ?>" class="alert-link mt-2 d-inline-block">
...
</script><?php /**PATH D:\_Mine\corporate\resources\views/voting-tables/partials/modal-import.blade.php ENDPATH**/ ?>