            ...
            <div class="row align-items-center g-2">
                <div class="col-md-5 col-lg-6">
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        ...
                        <?php if($totals['expected'] > 0): ?>
                        <span class="text-muted small">
                            <i class="ri-user-line me-1"></i>
                            <?php echo e(number_format($totals['total'])); ?> /
                            <?php echo e(number_format($totals['expected'])); ?>

                            habilitados
                            <span class="badge bg-<?php echo e($totals['participation'] >= 75 ? 'success' : ($totals['participation'] >= 50 ? 'warning text-dark' : 'secondary')); ?> ms-1">
                                <?php echo e($totals['participation']); ?>%
                            </span>
                        </span>
                        <?php endif; ?>
                    </div>
