                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name-field" name="name" class="form-control" 
                                    placeholder="Ej: Juan Pérez González" value="<?php echo e(old('name')); ?>" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="party-field" name="party" class="form-control" 
                                    placeholder="Ej: UNE, FRI .." value="<?php echo e(old('party')); ?>" required 
                                    maxlength="50" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="party_full_name-field" name="party_full_name" class="form-control" 
                                    placeholder="" value="<?php echo e(old('party_full_name')); ?>"
                                    maxlength="255" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="list_name-field" name="list_name" class="form-control" 
                                    placeholder="Ej: Lista 1, Alcandes, Concejales" value="<?php echo e(old('list_name')); ?>"
                                    maxlength="255" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="list_order-field" name="list_order" class="form-control" 
                                    placeholder="Ej: 1, 2, 3" value="<?php echo e(old('list_order')); ?>" 
                                    min="1" step="1" />
                                ...
                                <select class="form-control" name="election_type_category_id" id="election_type_category_id-field" required>
                                    ...
                                    <?php $__currentLoopData = $electionTypeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($etc->id); ?>" 
                                            ...
                                            (<?php echo e($etc->electionCategory->code); ?>)
                                        </option>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php echo $__env->make('candidates.scripts.geographic-scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?><?php /**PATH D:\_Mine\corporate\resources\views/candidates/partials/modal-form.blade.php ENDPATH**/ ?>