    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-0">¿Estás seguro que deseas eliminar la mesa?</p>
                <p class="fw-bold mt-2" id="deleteTableInfo"></p>
...
</div><?php /**PATH D:\_Mine\corporate\resources\views/voting-tables/partials/modal-delete.blade.php ENDPATH**/ ?>