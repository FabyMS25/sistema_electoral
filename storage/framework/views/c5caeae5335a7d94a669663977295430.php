...
<div class="row g-4 mb-3">
    ...
    <div class="col-sm">
        <div class="d-flex justify-content-sm-end">
            <form method="GET" action="<?php echo e(route('institutions.index')); ?>" class="d-flex">
                <div class="search-box me-2">
                    <input type="text" name="search" class="form-control search" 
                           placeholder="Buscar recinto..." value="<?php echo e(request('search')); ?>">
...
</div><?php /**PATH D:\_Mine\corporate\resources\views/institutions/partials/actions-bar.blade.php ENDPATH**/ ?>