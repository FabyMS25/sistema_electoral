    ...
    <div class="row">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <?php if(auth()->user()->allPermissions->contains('name', 'create_users')): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php $__currentLoopData = $user->assignments->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($assignment->voting_table_id): ?>
                                                <span class="badge bg-primary-subtle text-primary" title="<?php echo e($assignment->delegate_type_label); ?>">
                                                    <i class="ri-table-line"></i> Mesa <?php echo e($assignment->votingTable?->number ?? '—'); ?>

                                                </span>
                                            <?php elseif($assignment->institution_id): ?>
                                                <span class="badge bg-primary-subtle text-primary" title="Recinto">
                                                    <i class="ri-building-line"></i> <?php echo e($assignment->institution?->name ?? '—'); ?>

                                                </span>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($user->assignments->count() > 2): ?>
                                            <span class="badge bg-primary-subtle text-primary">+<?php echo e($user->assignments->count() - 2); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <?php if(auth()->user()->allPermissions->contains('name', 'view_users')): ?>
                                            ...
                                            <?php if(auth()->user()->allPermissions->contains('name', 'assign_roles') || auth()->user()->allPermissions->contains('name', 'assign_delegates')): ?>
                                            ...
                                            <?php if($user->id !== auth()->id()): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <form method="POST"
                                                          action="<?php echo e(route('users.activate', $user)); ?>"
                                                          class="d-inline">
                                                        <?php echo csrf_field(); ?>
