<?php $__env->startSection('title'); ?>
    Asignar Recinto - <?php echo e($user->name); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_2'); ?>
            <a href="<?php echo e(route('users.show', $user)); ?>"><?php echo e($user->name); ?> <?php echo e($user->last_name); ?></a>
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Usuario: <?php echo e($user->name); ?> <?php echo e($user->last_name); ?> (<?php echo e($user->email); ?>)</p>
                </div>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $electionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id); ?>" <?php echo e(old('election_type_id') == $type->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="">Seleccione...</option>
                                        <option value="delegado_general" <?php echo e(old('delegate_type') == 'delegado_general' ? 'selected' : ''); ?>>
                                            Delegado General
                                        </option>
                                        <option value="tecnico" <?php echo e(old('delegate_type') == 'tecnico' ? 'selected' : ''); ?>>
                                            Técnico/Soporte
                                        </option>
                                        <option value="observador" <?php echo e(old('delegate_type') == 'observador' ? 'selected' : ''); ?>>
                                            Observador
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="">Seleccione...</option>
                                <?php $__currentLoopData = $institutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipality => $instList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <optgroup label="<?php echo e($municipality); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?php $__errorArgs = ['assignment_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['credential_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   id="credential_number" name="credential_number" value="<?php echo e(old('credential_number')); ?>">
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">
                                            ...
                                            Desde: <?php echo e($assignment->assignment_date->format('d/m/Y')); ?>
                                        ...
                                        <p class="text-muted small mb-0">
                                            <i class="ri-id-card-line"></i> Cred: <?php echo e($assignment->credential_number); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\_Mine\corporate\resources\views/users/assign-institution.blade.php ENDPATH**/ ?>