<?php $__env->startSection('title'); ?> Permisos Directos - <?php echo e($user->name); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Permisos Directos <?php $__env->endSlot(); ?>
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title mb-0">
                        Permisos directos de: <?php echo e($user->name); ?> <?php echo e($user->last_name); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        desde <a href="<?php echo e(route('users.assign-roles.form', $user)); ?>">Asignar Roles</a>.
                    </div>

                    <form method="POST" action="<?php echo e(route('users.permissions.update', $user)); ?>" id="permissionsForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="permission-group">
                            <div class="permission-group-header">
                                <div class="form-check mb-0">
                                    <input type="checkbox" class="form-check-input group-checkbox"
                                           id="grp_<?php echo e(Str::slug($group)); ?>"
                                           data-group="<?php echo e(Str::slug($group)); ?>">
                                    <label class="form-check-label fw-bold" for="grp_<?php echo e(Str::slug($group)); ?>">
                                        <?php echo e($group); ?>

                                    </label>
                                </div>
                                <span class="group-count">
                                    <?php echo e($groupDirectCount); ?>/<?php echo e($groupTotal); ?> directos
                                </span>
                            </div>
                            <div class="permission-group-body">
                                ...
                                ?>
                                <div class="perm-item <?php echo e($isDirect ? 'is-direct' : ''); ?>">
                                    <div class="form-check d-flex align-items-start gap-1">
                                        ...
                                        <label class="form-check-label" for="perm_<?php echo e($permission->id); ?>">
                                            <span><?php echo e($permission->display_name ?? $permission->name); ?></span>
                                            <?php if($isFromRole && !$isDirect): ?>
                                            <span class="perm-scope-badge bg-light text-muted ms-1"
                                                  title="Heredado de rol">
                                                <i class="ri-shield-line"></i>
                                            </span>
                                            <?php endif; ?>
                                            <?php if($isDirect && $pivotScope && $pivotScope !== 'global'): ?>
                                            <span class="perm-scope-badge bg-info-subtle text-info ms-1">
                                                <?php echo e($pivotScope); ?>

                                            </span>
                                            <?php endif; ?>
                                            <?php if($permission->description): ?>
                                            <br><small class="role-perms-info"><?php echo e($permission->description); ?></small>
                                            <?php endif; ?>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    <?php if($user->roles->count() > 0): ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="ps-2">
                                <?php $__currentLoopData = $role->permissions->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <small class="d-block text-muted">
                                    <i class="ri-checkbox-blank-circle-fill me-1" style="font-size:0.45rem;vertical-align:middle;"></i>
                                    <?php echo e($rp->display_name ?? $rp->name); ?>

                                </small>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($role->permissions->count() > 5): ?>
                                <small class="text-muted">
                                    + <?php echo e($role->permissions->count() - 5); ?> más...
                                </small>
                                <?php endif; ?>
                            </div>
                            <?php else: ?>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span class="badge bg-success" id="directCount"><?php echo e($currentPermissions->count()); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <small>Por roles</small>
                        <span class="badge bg-primary"><?php echo e(count($rolePermIds)); ?></span>
                    </div>
                    <div class="d-flex justify-content-between">
                        <small>Total acceso</small>
                        <span class="badge bg-dark">
                            <?php echo e(count(array_unique(array_merge($directIds, $rolePermIds)))); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\_Mine\sistema_electoral\resources\views/users/permissions.blade.php ENDPATH**/ ?>