    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(request()->routeIs('voting-table-votes.*') ? 'active' : ''); ?>"
                       href="#sidebarVotos"
                       data-bs-toggle="collapse"
                       role="button"
                       aria-expanded="<?php echo e(request()->routeIs('voting-table-votes.*') ? 'true' : 'false'); ?>"
                       aria-controls="sidebarVotos">
                        <i class="ri-keyboard-fill"></i>
                        <span>Gestión de Votos</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(request()->routeIs('voting-table-votes.*') ? 'show' : ''); ?>"
                         id="sidebarVotos">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('voting-table-votes.index')); ?>?status=pendiente"
                                   class="nav-link">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_observations')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('observations.stats')); ?>"
                                   class="nav-link">
