            ...
            <nav class="navbar navbar-expand-lg navbar-landing " id="navbar"><!-- fixed-top -->
                <div class="container">
                    <a class="navbar-brand" href="index">
                        <img src="<?php echo e(URL::asset('build/images/lofo_elections_large.png')); ?>" class="card-logo card-logo-dark" alt="logo dark"
                            height="50">
                        <img src="<?php echo e(URL::asset('build/images/lofo_elections_large.png')); ?>" class="card-logo card-logo-light" alt="logo light"
                            height="50">
                    </a>
