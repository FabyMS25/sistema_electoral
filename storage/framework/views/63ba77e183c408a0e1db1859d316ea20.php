...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Registro de Votos <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> <?php echo e($electionType->name ?? 'Elecciones'); ?> <?php $__env->endSlot(); ?>
                ...
                <div class="card-body py-2 px-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold"><?php echo e($votingTables->total()); ?></h3>
                        </div>
                ...
                <div class="card-body py-2 px-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold"><?php echo e(number_format($totals['expected'] ?? 0)); ?></h3>
                        </div>
                ...
                <div class="card-body py-2 px-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold"><?php echo e($totals['participation'] ?? 0); ?>%</h3>
                        </div>
            ...
            <div class="col-6 col-md-3 col-xl-2">
                <div class="card bg-<?php echo e($color); ?> text-white h-100">
                    <div class="card-body py-2 px-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <div class="small text-white-50"><?php echo e($name); ?></div>
                                <h3 class="mb-0 fw-bold"><?php echo e(number_format($total)); ?></h3>
