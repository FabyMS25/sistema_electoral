        ...
        <div class="filters-row">
            <form method="GET" action="<?php echo e(route('candidates.index')); ?>" id="filter-form">
                ...
                <div class="row g-2 mt-2">
                    ...
                    <div class="col-md-4 filter-item">
                        <select name="province_id" class="form-select" id="filter-province" <?php echo e(request('department_id') ? '' : 'disabled'); ?>>
                            <option value="">Todas las provincias</option>
                            <?php if(isset($provinces) && $provinces->isNotEmpty()): ?>
                    ...
                    <div class="col-md-4 filter-item">
                        <select name="municipality_id" class="form-select" id="filter-municipality" <?php echo e(request('province_id') ? '' : 'disabled'); ?>>
                            <option value="">Todos los municipios</option>
                            <?php if(isset($municipalities) && $municipalities->isNotEmpty()): ?>
                                <?php $__currentLoopData = $municipalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($municipality->id); ?>" <?php echo e(request('municipality_id') == $municipality->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex gap-2">
                            ...
                            <?php if(request()->hasAny(['search', 'election_type_category_id', 'department_id', 'province_id', 'municipality_id'])): ?>
                                <a href="<?php echo e(route('candidates.index')); ?>" class="btn btn-outline-secondary" title="Limpiar filtros">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <?php if(request('search')): ?>
                        <span class="badge bg-primary d-inline-flex align-items-center">
                            <i class="ri-search-line me-1"></i> "<?php echo e(request('search')); ?>"
                            <a href="<?php echo e(route('candidates.index', request()->except(['search', 'page']))); ?>" class="text-white ms-2">
                                <i class="ri-close-line"></i>
                            </a>
                        </span>
                    <?php endif; ?>
                    ...
                    <?php if(request('election_type_category_id') && $electionTypeCategories->find(request('election_type_category_id'))): ?>
                        ...
                        <span class="badge bg-info d-inline-flex align-items-center">
                            ...
                            <?php echo e($selectedCategory->electionType->name); ?> - <?php echo e($selectedCategory->electionCategory->name); ?>

                            <a href="<?php echo e(route('candidates.index', request()->except(['election_type_category_id', 'page']))); ?>" class="text-white ms-2">
                                <i class="ri-close-line"></i>
                            </a>
                        </span>
                    <?php endif; ?>
                    ...
                    <?php if(request('department_id')): ?>
                        ...
                        <?php if($dept): ?>
                            <span class="badge bg-success d-inline-flex align-items-center">
                                <i class="ri-map-pin-line me-1"></i> <?php echo e($dept->name); ?>

                                <a href="<?php echo e(route('candidates.index', request()->except(['department_id', 'province_id', 'municipality_id', 'page']))); ?>" class="text-white ms-2">
                                    <i class="ri-close-line"></i>
                                </a>
                            </span>
                        <?php endif; ?>
                    ...
                    <?php if(request('province_id') && isset($provinces)): ?>
                        <?php
                            $prov = $provinces->find(request('province_id'));
                        ?>
                        <?php if($prov): ?>
                            <span class="badge bg-warning d-inline-flex align-items-center">
                                <i class="ri-map-pin-line me-1"></i> <?php echo e($prov->name); ?>

                                <a href="<?php echo e(route('candidates.index', request()->except(['province_id', 'municipality_id', 'page']))); ?>" class="text-white ms-2">
                                    <i class="ri-close-line"></i>
                                </a>
                            </span>
                        <?php endif; ?>
                    ...
                    <?php if(request('municipality_id') && isset($municipalities)): ?>
                        <?php
                            $mun = $municipalities->find(request('municipality_id'));
                        ?>
                        <?php if($mun): ?>
                            <span class="badge bg-secondary d-inline-flex align-items-center">
                                <i class="ri-map-pin-line me-1"></i> <?php echo e($mun->name); ?>

                                <a href="<?php echo e(route('candidates.index', request()->except(['municipality_id', 'page']))); ?>" class="text-white ms-2">
                                    <i class="ri-close-line"></i>
                                </a>
                            </span>
                        <?php endif; ?>
...
<?php /**PATH D:\_Mine\corporate\resources\views/candidates/partials/actions-bar.blade.php ENDPATH**/ ?>