{{-- resources/views/institutions/partials/modal-import.blade.php --}}
            ...
            <form method="POST" action="{{ route('institutions.import') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <br>
                        <a href="{{ route('institutions.template') }}" class="alert-link mt-2 d-inline-block">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Los departamentos, provincias, municipios y localidades deben existir en el sistema</li>
                            <li>El código del recinto debe ser único (si se proporciona)</li>
                            <li>Los nombres de los recintos deben ser únicos</li>
                        </ul>
                    </div>
                </div>
