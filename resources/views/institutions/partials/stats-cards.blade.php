    ...
    <div class="col-xl-2 col-md-3 mb-1">
        <div class="card stats-card bg-success text-white">
            <div class="card-body">
                ...
                <small class="text-white-50">{{ $activePercentage }}% del total</small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-2 col-md-3 mb-1">
        <div class="card stats-card bg-warning text-white">
            <div class="card-body">
                ...
                <h3 class="mb-0 text-white">{{ number_format($totalOperative) }}</h3>
    ...
    <div class="col-xl-2 col-md-3 mb-1">
        <div class="card stats-card bg-danger text-white">
            <div class="card-body">
                ...
                <h3 class="mb-0 text-white">{{ number_format($totalInactive + $totalMaintenance) }}</h3>
    ...
    <div class="col-12">
        <div class="d-flex gap-2 justify-content-end">
            ...
            <span class="badge bg-danger-subtle text-danger">
                ...
                {{ $totalInactive }} recintos inactivos
            </span>
            @endif
            @if($totalMaintenance > 0)
            <span class="badge bg-warning-subtle text-warning">
                <i class="ri-tools-line me-1"></i>
                {{ $totalMaintenance }} en mantenimiento
            </span>
            @endif
        </div>
    </div>
