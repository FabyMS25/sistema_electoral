                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="party_full_name-field" name="party_full_name" class="form-control"
                                    placeholder="Nombre completo del partido político" value="{{ old('party_full_name') }}" maxlength="255" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="list_name-field" name="list_name" class="form-control"
                                    placeholder="Ej: Lista 1, Frente Amplio, Juntos" value="{{ old('list_name') }}" maxlength="255" />
                                ...
                                <select class="form-control" name="election_type_category_id" id="election_type_category_id-field" required>
                                    ...
                                    @foreach($electionTypeCategories as $etc)
                                        <option value="{{ $etc->id }}"
                                            ...
                                            ({{ $etc->electionCategory->code }}) - Franja {{ $etc->ballot_order }}
                                        </option>
                                    @endforeach
                                </select>
