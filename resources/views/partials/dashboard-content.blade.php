    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-primary card-animate">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <div class="d-flex align-items-center">
                        <span class="badge bg-white text-primary me-2">{{ $progressPercentage }}%</span>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h3 class="text-white mb-0">
                            <span class="counter-value" data-target="{{ $reportedTables }}">0</span>/<span class="fs-5">{{ $totalTables }}</span>
                        </h3>
                            ...
                            <div class="col-md-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="mb-1">{{ $reportedTables }}</h4>
                            ...
                            <div class="col-md-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="mb-1">{{ $totalTables - $reportedTables }}</h4>
